...
void AMyHUD::BeginPlay()
{
	...
	UseWidget(EWidgetID::PauseMenu, true);
	UMainMenuWidget* MainMenu = Cast<UMainMenuWidget>(UseWidget(EWidgetID::MainMenu, true));
}
...
void AMyHUD::RemoveCurrentWidgetFromViewport()
{
	if (CurrentWidget)
	{
		...
		CurrentWidgetID = EWidgetID::MainMenu;
	}
}
UUserWidget* AMyHUD::AddWidgetToViewportByClass(
...
UUserWidget* AMyHUD::UseWidget(EWidgetID widgetID, bool RemovePrevious,
	int32 ZOrder)
{
